...
<html lang="en">
   <head>
      ...
      <!-- Responsive-->
      <link rel="stylesheet" href="css/front-end/responsive.css">
      <!-- fevicon -->
      <link rel="icon" href="images/fevicon.png" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="css/front-end/jquery.mCustomScrollbar.min.css">
   ...
   <body class="main-layout">
            ...
            @foreach ($content as $a)
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div id="box_ho" class="why-box">
                     <i><img src="images/{{$a->gambar}}" alt="#" /></i>
                     <h3>{{$a->judul}}</h3>
                     <p>{{$a->deskripsi}}</p>
                  </div>
      ...
      <!-- end footer -->
      <!-- Javascript files-->
      <script src="js/front-end/jquery.min.js"></script>
      <script src="js/front-end/popper.min.js"></script>
      <script src="js/front-end/bootstrap.bundle.min.js"></script>
      <script src="js/front-end/jquery-3.0.0.min.js"></script>
      <script src="js/front-end/plugin.js"></script>
      <!-- sidebar -->
      <script src="js/front-end/jquery.mCustomScrollbar.concat.min.js"></script>
      <script src="js/front-end/custom.js"></script>
